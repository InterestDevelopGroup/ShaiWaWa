...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _babyTop = [[UIView alloc] initWithFrame:CGRectMake(0, 7, 299, 44)];
        //_babyTop.backgroundColor = [UIColor whiteColor];

        _touXiangImg = [[UIImageView alloc] initWithFrame:CGRectMake(12, 6, 35, 35)];
        _touXiangImg.image = [UIImage imageNamed:@"baby_baobei.png"];
        
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(70, 6, 54, 16)];
        _nameLabel.backgroundColor = [UIColor clearColor];
        _nameLabel.font = [UIFont systemFontOfSize:13];
        _nameLabel.textColor = [UIColor colorWithRed:103/255.0 green:192/255.0 blue:15/255.0 alpha:1.0];
        _nameLabel.text = @"小龙李";
        
        _olderLabel = [[UILabel alloc] initWithFrame:CGRectMake(70, 28, 66, 13)];
        ...
        _imgOrVideoScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 56, 299, 135)];
        ...
        _contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 192, 299, 159)];
        ...
        _addrLabel = [[UILabel alloc] initWithFrame:CGRectMake(29, 18, 263, 17)];
        ...
        _locationImg = [[UIImageView alloc] initWithFrame:CGRectMake(12, 19, 12, 16)];
        _locationImg.image = [UIImage imageNamed:@"square_zizhi.png"];
        
        _contentTextView = [[UITextView alloc] initWithFrame:CGRectMake(12, 28, 280, 110)];
        ...
        _praiseButton.frame = CGRectMake(12, 139, 55, 21);
        
        _praiseUserView = [[UIView alloc] initWithFrame:CGRectMake(75, 139, 85, 21)];
        ...
        _pinLunButton.frame = CGRectMake(217, 139, 40, 19);
        ...
        _moreButton.frame = CGRectMake(265, 139, 21, 21);
